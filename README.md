...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libint-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libint-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libint libint-fortran-devel
# for installing globally
pixi global install libint libint-fortran-devel
```
...
It is possible to list all of the versions of `libint` available on your platform:
...
```
pixi search libint --channel conda-forge
```
